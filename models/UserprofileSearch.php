...
class UserprofileSearch extends Userprofile
{
    ...
    {
        return [
            [['id', 'career_level', 'communication_level', 'organizational_level', 'job_related_level', 'phone_number'], 'integer'],
            [['full_name', 'gender', 'dob', 'years_of_experience', 'industry', 'location', 'about_me', 'profile_picture', 'professional_title', 'address', 'website', 'email'], 'safe'],
        ];
    }
